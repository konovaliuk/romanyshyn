...
<fmt:setBundle basename="text" />
  ...
  <div class="form">
  	...
  	<div class="row"><label><fmt:message key="form.from" /></label><input type="text" name="place_from" id="place_from" required pattern="^[A-ZА-ЯЇІ][a-zа-яії]{3,20}$"></div>
  	<div class="row"><label><fmt:message key="form.to" /></label><input type="text" name="place_to" id="place_to" required pattern="^[A-ZА-ЯЇІ][a-zа-яії]{3,20}$"></div>
    ...
    <div class="row"><label><fmt:message key="form.first.name" /></label><input type="text" name="first_name" id="first_name" required pattern="^[A-ZА-ЯЇІ][a-zа-яії]{3,20}$"></div>
    <div class="row"><label><fmt:message key="form.last.name" /></label><input type="text" name="last_name" id="last_name" required pattern="^[A-ZА-ЯЇІ][a-zа-яії]{3,20}$"></div>
